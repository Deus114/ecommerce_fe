...
import { callFetchCategory, callUploadBookImg, updateBook } from '../../../services/apiServices';
            ...
            const arrThumbnail = [
                {
                    ...
                    status: 'done',
                    url: `${import.meta.env.VITE_BACKEND_URL_AVATAR}/images/book/${dataUpdate.thumbnail}`,
                }
            ]
