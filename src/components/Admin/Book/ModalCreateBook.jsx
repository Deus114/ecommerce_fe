...
import { callFetchCategory, callUploadBookImg, createBook } from '../../../services/apiServices';
...
const ModalCreateBook = (props) => {
    ...
    const onFinish = async (values) => {
        if (dataThumbnail.length === 0) {
            notification.error({
                message: "Lỗi dữ liệu nhập",
                description: "Bạn phải upload thumbnail"
            });
            return;
        }
        if (dataSlider.length === 0) {
            notification.error({
                message: "Lỗi dữ liệu nhập",
                description: "Bạn phải upload slider"
            });
            return;
        }
